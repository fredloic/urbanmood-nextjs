    ...
    if (favourite) {
        return (
            <div className="relative hover:-translate-y-2 hover:shadow-2xl hover:shadow-zinc-400 duration-300 h-xl">
                <button
                    className="text-red-500 text-4xl absolute z-30 top-6 right-5"
                    onClick={() => {
                ...
                <Link href={`/pages/shop/${product.ProductId}`} className="relative h-full">
                    <div className="flex flex-col items-center gap-2 w-2xs h-full bg-[#f4f0eb] p-4 my-2 rounded-md border">
                        <img src={`${product.url}`} className="w-72 h-72 object-cover rounded-md mb-1" />
        ...
        return (
            <div className="relative hover:-translate-y-2 hover:shadow-2xl hover:shadow-zinc-400 duration-300 h-xl">
                <button
                    className="text-zinc-400 hover:text-red-500 text-4xl absolute z-30 top-6 right-5"
                    onClick={() => {
                        if (user) {
